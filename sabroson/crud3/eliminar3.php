...
$id=$_POST['id'];
echo $id;
$archivo=fopen("../archivos/repartidor.csv","r")or die("error");//lee el archivo usuarios
$archivo2=fopen("../archivos/repartidortemp.csv","a+")or die("error");//crea el archivo temporal
while(!feof($archivo)){
...
unlink("../archivos/repartidor.csv");//con unlink borra el anterior
rename("../archivos/repartidortemp.csv","../archivos/repartidor.csv");//// renombra con el que trabajamos y lo deja como nuevo archivo de datos real
