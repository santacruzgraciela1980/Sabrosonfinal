<?php
    ...
    $archivo=fopen("../archivos/repartidor.csv","r")or die("error");
    $archivo2=fopen("../archivos/repartidortemp.csv","a+")or die("error");
    ...
    fclose($archivo);
    fclose($archivo2);
    unlink("../archivos/repartidor.csv");
    rename("../archivos/repartidortemp.csv","../archivos/repartidor.csv");
