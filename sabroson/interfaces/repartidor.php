...
<!-- Modal -->
<form action="../crud3/agregar3.php" method="POST">

<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agregar Repartidor</h5>
...
<table class="table table-dark">
  ...
  <tbody>
    <?php
      $archivo=fopen("../archivos/repartidor.csv","r");
      while(!feof($archivo)){
        $linea=fgets($archivo);
        $datos=explode("|",$linea);
        if(strlen($linea)>0){
          ...
          echo "<tr>
                  ...
                  echo "<td>$res2</td>";
                  echo "<td>
                        <form action='../crud3/eliminar3.php' method='POST'>
                        ...
                        <a href='../crud3/editar3.php?id=$datos[0]'>
...
<div class="container">
       <form  class="formulario" action="../reportes/reporte_repartidor.php" method="POST">
